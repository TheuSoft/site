...
import { MotionDiv, fadeInUp, staggerContainer } from '@/providers/motion-provider';
import {
  EnvelopeIcon,
  PhoneIcon,
  MapPinIcon,
...
export default function ContatoPage() {
  ...
  return (
    <main className="pt-16">
      ...
      <Section id="contato-hero" className="text-center">
        <MotionDiv variants={fadeInUp}>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Tem um projeto em mente? Vamos conversar! Estou sempre aberto a novos 
            desafios e oportunidades interessantes.
          </p>
        </MotionDiv>
      </Section>
            ...
            <Card className="bg-gradient-to-br from-emerald-600/10 to-emerald-400/5 border-emerald-600/20">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-emerald-400 font-medium">Disponível para projetos</span>
                </div>
      ...
      {/* FAQ Section */}
      <Section id="faq" className="bg-gradient-to-r from-emerald-600/5 to-emerald-400/5 border-y border-emerald-600/10">
          ...
          {[
            {
              ...
              answer: 'Começo com uma reunião para entender suas necessidades, depois crio um plano detalhado, desenvolvo a solução e mantenho comunicação constante durante todo o processo.',
            },
            {
              question: 'Quanto tempo leva um projeto?',
              answer: 'Depende da complexidade, mas sites simples levam 2-4 semanas, enquanto aplicações complexas podem levar 2-6 meses. Sempre fornecerei um cronograma detalhado.',
            },
            {
              question: 'Você oferece suporte pós-entrega?',
              answer: 'Sim! Ofereço 30 dias de suporte gratuito após a entrega, e também serviços de manutenção contínua se necessário.',
            },
            {
              question: 'Como funciona o pagamento?',
              answer: 'Geralmente trabalho com 50% antecipado e 50% na entrega. Para projetos maiores, podemos dividir em mais parcelas conforme os marcos do projeto.',
            },
          ].map((faq, index) => (
