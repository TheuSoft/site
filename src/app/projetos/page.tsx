...
export default function ProjetosPage() {
  ...
  return (
    <main className="pt-16">
      ...
      <Section id="projetos-hero" className="text-center">
        <MotionDiv variants={fadeInUp}>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            até soluções mobile e APIs robustas.
          </p>
        </MotionDiv>
      </Section>
              ...
              <Card className="bg-dark-800 border-dark-700 hover:border-emerald-600/50 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-600/10 h-full flex flex-col">
                ...
                <CardContent className="flex-1 flex flex-col justify-between">
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.slice(0, 4).map((tech) => (
                        <Badge key={tech} variant="outline" className="text-xs border-dark-600 text-gray-400">
                          {tech}
                        </Badge>
                      ))}
                  ...
                  <div className="flex gap-2 mt-6">
                    {project.demoUrl && (
                      <Button size="sm" variant="outline" className="flex-1 border-emerald-600 text-emerald-400 hover:bg-emerald-600/10">
                        <Link
                    ...
                    {project.githubUrl && (
                      <Button size="sm" variant="outline" className="flex-1 border-gray-600 text-gray-400 hover:bg-gray-600/10">
                        <Link
      ...
      {/* Stats Section */}
      <Section id="stats" className="bg-gradient-to-r from-emerald-600/5 to-emerald-400/5 border-y border-emerald-600/10">
        <MotionDiv variants={fadeInUp}>
