...
export default function Home() {
  ...
  const { yParallax, yParallaxReverse, scaleParallax, opacityFade } = useScrollEffects();
        ...
        <div className="relative z-10 text-center space-y-8 max-w-4xl mx-auto">
          <div className="space-y-6">
            ...
            >
              ...
              >
                <p className="text-gray-400 font-mono text-sm">{"// Iniciando sistemas..."}</p>
              </MotionDiv>
            </MotionDiv>
            ...
            >
              ...
              >
                <div className="text-2xl sm:text-3xl text-gray-300 font-light">
                  Eu sou <span className="text-emerald-400 font-semibold">Matheus</span>
                </div>
              </MotionDiv>
              <MotionDiv
            ...
            <MotionDiv variants={fadeInUp} className="max-w-2xl mx-auto">
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
                Especialista em criar experiências digitais inovadoras usando as mais 
                modernas tecnologias de desenvolvimento web e mobile.
              </p>
            </MotionDiv>
          </div>

          {/* Tech Stack Indicators */}
          <MotionDiv variants={fadeInUp} className="flex flex-wrap justify-center gap-4 py-8">
            {['REACT', 'NEXT.JS', 'TYPESCRIPT', 'NODE.JS', 'PYTHON'].map((tech, index) => (
              <div 
                key={tech}
                className={`px-4 py-2 rounded-sm border font-mono text-sm ${
                  index % 3 === 0 ? 'border-emerald-400/30 text-emerald-400' :
                  index % 3 === 1 ? 'border-blue-400/30 text-blue-400' :
          ...
          {/* CTA Buttons */}
          <MotionDiv variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <Section id="about-preview" className="relative">
        ...
        <div className="relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 font-mono text-sm">{"// Construindo o amanhã com código"}</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-6">
                ...
                >
                  <h3 className="text-2xl font-bold text-emerald-400 mb-4 font-mono">FRONTEND_MASTERY</h3>
                  <p className="text-gray-300 leading-relaxed">
                    Especialista em criar interfaces modernas e responsivas com React, Next.js e TypeScript. 
                    Foco em performance, acessibilidade e experiência do usuário excepcional.
                  </p>
                </MotionDiv>
                ...
                <MotionDiv
                  ...
                  className="futuristic-border p-6 cursor-pointer"
                >
                  <h3 className="text-2xl font-bold text-blue-400 mb-4 font-mono">BACKEND_ARCHITECT</h3>
                  <p className="text-gray-300 leading-relaxed">
                    Desenvolvimento de APIs robustas e escaláveis com Node.js, Express e bancos de dados 
                    modernos. Expertise em arquitetura de microsserviços e DevOps.
                  </p>
                </MotionDiv>
              </div>
            </MotionDiv>
            ...
            >
              ...
              >
                ...
                >
                  <h3 className="text-3xl font-bold text-white mb-4 font-mono">5+ ANOS</h3>
                </MotionDiv>
                
                <p className="text-gray-400 mb-6">De experiência criando soluções digitais inovadoras</p>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <span className="text-gray-400">Tecnologias Dominadas</span>
                    <MotionDiv
                      initial={{ opacity: 0, scale: 0 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      viewport={{ once: true }}
      ...
      <Section id="featured-projects" className="relative">
        ...
        <div className="relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 font-mono text-sm">{"// Projetos que definem o futuro"}</p>
            <p className="text-xl text-gray-300 mt-4 max-w-2xl mx-auto">
              Soluções digitais inovadoras construídas com as mais modernas tecnologias
            </p>
          </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Badge 
                        ...
                        className={`font-mono text-xs ${
                          index % 3 === 0 ? 'bg-emerald-400/20 text-emerald-400' :
                          index % 3 === 1 ? 'bg-blue-400/20 text-blue-400' :
                    ...
                    <div className="space-y-6">
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.slice(0, 3).map((tech) => (
                          <Badge key={tech} variant="outline" className="text-xs font-mono border-gray-600 hover:border-emerald-400/50 transition-colors">
                            {tech}
                          </Badge>
                        ))}
                      ...
                      <div className="flex gap-3">
                        {project.demoUrl && (
                          <Button size="sm" variant="outline" className="flex-1 border-emerald-400/30 text-emerald-400 hover:bg-emerald-400/10 font-mono">
                            <Link
                        ...
                        {project.githubUrl && (
                          <Button size="sm" variant="outline" className="flex-1 border-blue-400/30 text-blue-400 hover:bg-blue-400/10 font-mono">
                            <Link
          ...
          <div className="text-center mt-16">
            <Button size="lg" className="bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 text-white font-mono">
      ...
      <Section className="relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-12">
          <div className="space-y-6">
            ...
            <p className="text-gray-400 font-mono text-sm">{"// Transformando ideias em realidade digital"}</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-8">
            <p className="text-xl text-gray-300 leading-relaxed">
              Estou sempre em busca de novos desafios tecnológicos e projetos inovadores. 
              Vamos construir juntos a próxima geração de soluções digitais.
            </p>
